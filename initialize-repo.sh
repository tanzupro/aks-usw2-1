...
echo
echo Continue to create GitHub TAP GitOps Repo aks-usw2-1
echo     https://github.com/tanzupro/aks-usw2-1
echo
...
git add .
git commit -am "."
gh repo create aks-usw2-1 --private
git remote add origin https://github.com/tanzupro/aks-usw2-1
git branch -M main
